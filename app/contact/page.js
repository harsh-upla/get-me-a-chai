  ...
  return (
    <Skeleton name="blog-card" loading={false}>
      <main className="min-h-[88.2vh]  bg-[#000000] bg-[radial-gradient(#ffffff33_1px,#00091d_1px)] bg-size-[20px_20px] flex items-center justify-center p-6">
        ...
        <section className="relative w-full  max-w-4xl flex items-center justify-center">
          {/* Left: Info */}
          <div
            className="p-8 rounded-2xl
                        backdrop-blur-xl w-2xl
          ...
          >
            ...
            <div className="mt-6 space-y-4 text-sm text-white/70 ml -56">
              <div>
